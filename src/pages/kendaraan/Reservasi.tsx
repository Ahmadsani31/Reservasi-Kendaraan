      ...
      {isLoading ? (
        ...
        <>
          <Card className="mb-5">
            ...
            <CardContent>
              <p className="text-muted-foreground text-center bg-blue-100 text-gray-950 rounded-sm p-1">
                {row.kegiatan}
              </p>
              <p className="text-muted-foreground text-center text-xs text-gray-950 rounded-sm p-1">
                {format(row.created_at, "cccc, d LLL y | HH:mm")}
              </p>
            </CardContent>
          </Card>
          <div className="my-2">
            <Card className="p-4">
              <Button
                type="button"
                variant="ghost"
                onClick={() => setDialogCheckpoint(!dialogCheckpoint)}
          ...
          <div className="my-2">
            <Card className="p-4">
              <Button
                variant="ghost"
                onClick={() => setDialogExit(!dialogExit)}
      ...
      <Dialog open={dialogCheckpoint} onOpenChange={setDialogCheckpoint}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Silahkan foto kondisi terkini saat melakukan proses pengisian BBM
              Kendaraan
            </DialogDescription>
          </DialogHeader>
                  ...
                  <>
                    <div className="relative ">
                      ...
                      <button
                        type="button"
                        onClick={retakeImage}
                        className="flex items-center absolute bottom-0 right-0 bg-amber-500 text-white px-3 py-1 rounded-sm">
                        <CameraOff className="mr-2" /> ambil ulang foto
                      </button>
                    </div>
                  </>
                ) : (
            ...
            <form onSubmit={handleSubmit} method="post">
              ...
              <div className="mb-3">
                ...
                <Input
                  ...
                  name="spidometer"
                  id="spidometer"
                  value={formExit.spidometer}
                  onChange={handelInput}
                  className={errors.spidometer ? "border-red-500" : ""}
                  placeholder="Nilai spidometer"
                />
                {errors.spidometer && (
                  <p className="text-sm ms-1 text-red-500">
                    {errors.spidometer}
                  </p>
                )}
              </div>
